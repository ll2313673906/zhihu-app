            ...
            .content{
                ...
                .content-header{
                    ...
                    .header-info {
                        ...
                        .header-btn{
                            background:#eee;
                            box-shadow: 0 6px 10px 0 rgba(0,132,255,.06);
                            font-weight: 500;
                            font-size: 14px;
                            padding: 5px 12px;
                            height:32px;
